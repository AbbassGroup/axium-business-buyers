...
export async function POST(req: Request) {
  try {
    ...
    const { name, email, phone, industry, budget, timeline } = body;
    ...
    const mailOptions = {
      from: `"Axium Inquiry" <${process.env.EMAIL_USER}>`,
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <div class="field">
                <span class="label">Industry Interest</span>
                <div class="value">${industry || 'Not specified'}</div>
              </div>
              <div class="field">
            ...
            <div class="footer">
              <p>This email was sent from the Axium website contact form.</p>
            </div>
          </div>
        </body>
        </html>
